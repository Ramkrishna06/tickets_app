...
import 'package:ticket_app/screens/tickets/widgets/ticketposition.dart';
...
class _TicketScreenState extends State<TicketScreen> {
  ...
  void didChangeDependencies(){
    if(ModalRoute.of(context)!.settings.arguments!=null){
      ...
      print("passed indx is ${args["index"]}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Appstyle.ticketorange,
        title: Text("Data"),
      ),
      body: Stack(
        children: [
          ListView(
            ...
            children: [
              ...
              TicketView(ticket: ticketList[ticketindex], isColor: false),
              SizedBox(
                height: 10,
              ),
              Container(
          ...
          TicketPositionCircle(postion: true,),
          TicketPositionCircle(postion: null),
        ],
      ),
    );
  }
